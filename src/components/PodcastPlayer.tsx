        ...
        <div className="flex items-end gap-4">
          ...
          >
            <svg
              ...
              className={`transition-all duration-200 ${copied ? "text-emerald-400 scale-110" : "text-white/50 group-hover:text-white/80 group-hover:scale-110"}`}
            >
              {copied ? (
            ...
            <span className={`text-[10px] font-semibold transition-colors ${copied ? "text-emerald-400" : "text-white/40"}`}>
              {copied ? "Copied!" : "Share"}
            </span>
          </button>
        </div>
