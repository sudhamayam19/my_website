        ...
        <div className="mx-auto max-w-7xl">
          ...
          <section className="editorial-card mt-8 p-6 sm:p-8">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/admin/tillu" className="rounded-full border border-[#d3c1a8] bg-[#fffaf2] px-4 py-2 text-sm font-bold text-[#1f6973] hover:border-[#1f6973] transition">🤖 Tillu Chat</Link>
              <Link href="/admin/tillu-corner" className="rounded-full border border-[#d3c1a8] bg-[#fffaf2] px-4 py-2 text-sm font-bold text-[#1f6973] hover:border-[#1f6973] transition">📁 Tillu Corner</Link>
              <Link href="/admin/discussions" className="rounded-full border border-[#d3c1a8] bg-[#fffaf2] px-4 py-2 text-sm font-bold text-[#1f6973] hover:border-[#1f6973] transition">💬 Discussions</Link>
